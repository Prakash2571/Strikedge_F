...
export interface OrderStreamStatusContract { any_stream_live: boolean; market_data_health_is_not_order_stream_health: true; brokers: ({ broker: "zerodha" | "dhan"; wiring: "not_built" | "not_wired" | "gated_off" | "armed"; gate_env_var: string; gate_enabled: boolean; health: { state: "DISABLED" | "DOWN" | "CONNECTING" | "LIVE" | "RECONNECTED_PENDING_RECONCILE"; connected: boolean; authorised: boolean; lastEventAt: number | null; disconnects: number; reconcilePending: boolean; detail: string; } | null; fills_observed_by: "rest_polling_only" | "stream_primary_rest_reconcile"; detail: string; })[]; }
